...
export default ChartComponent.extend(FloatingTooltipMixin, {
  ...
  showDetails: Ember.computed('isInteractive', function() {
    return function(data, i, element, that) {
      ...
      // }
        ...
        // Show tooltip
        var formatLabel = that.get('formatLabel');
        // Line 1
        var content = "<span class=\"tip-label\">" + data.label + "</span>";
        // Line 2
        content += "<span class=\"name\">" + that.get('tooltipValueDisplayName') + ": </span>";
        content += "<span class=\"value\">" + formatLabel(Math.floor((data.value / 500))) + "</span>";
        that.showTooltip(content, d3.event);
  ...
  updateVis: function() {
    ...
    circles.enter().append("circle")
      ...
      .on("mouseover", function(d, i) { return showDetails(d, i, this, that); })
      .on("mouseout", function(d, i) { return hideDetails(d, i, this, that); });
